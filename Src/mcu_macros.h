...
#define IWDG_REGISTERS_START_ADDR 0x40003000
#define IWDG_START_KEY_VALUE 0xCCCC
#define IWDG_PREVENT_RESET_VALUE 0xAAAA
#define IWDG_REGISTER_EDIT_UNLOCK_VALUE 0x5555
