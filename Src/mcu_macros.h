...
#define MPU_RASR_SIZE_START_BIT 1
#define MPU_RASR_ATTRS_B_BIT 16
#define MPU_RASR_ATTRS_C_BIT 17
#define MPU_RASR_ATTRS_S_BIT 18
#define MPU_RASR_ATTRS_TEX_START_BIT 19
#define MPU_RASR_ATTRS_AP_START_BIT 24
#define MPU_RASR_ATTRS_XN_BIT 28
